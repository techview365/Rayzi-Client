...
import com.example.chiky.databinding.ActivityVideoCallFakeBinding;
...
import com.example.chiky.viewModel.FakeVideoCallViewModel;
            ...
            cameraProviderFuture.addListener(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        cameraProvider.bindToLifecycle(FakeVideoCallActivity.this, cameraSelector, preview);
