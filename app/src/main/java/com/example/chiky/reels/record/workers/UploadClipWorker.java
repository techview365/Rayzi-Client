package com.example.chiky.reels.record.workers;
...
import com.example.chiky.reels.record.UploadActivity;
...
public class UploadClipWorker extends Worker {
    ...
    private boolean doActualWork(
        ...
        hashMap.put("size", RequestBody.create(MediaType.parse("text/plain"), VideoUtil.getFileSizeInMB(video) + " MB"));
