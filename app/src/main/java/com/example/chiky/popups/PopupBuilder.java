package com.example.chiky.popups;
...
import com.example.chiky.databinding.ItemPopup4Binding;
import com.example.chiky.databinding.ItemSimplepopupBinding;
import com.example.chiky.databinding.PopupRcoinConvertBinding;
import com.example.chiky.databinding.PopuplivecloseBinding;
                ...
                if (!s.toString().isEmpty()) {
                    ...
                    if (coin[0] < rCoinForDiamond) {
                        ...
                        if (isCashOut) {
                            ...
                            binding.tvDiamondsValue.setText("You Will Receive " + diamond + Const.getCurrency());
                        } else {
                            int diamond = coin[0] / rCoinForDiamond;
