...
import com.example.chiky.agora.rtc.AgoraEventHandler;
import com.example.chiky.agora.rtc.Constants;
import com.example.chiky.agora.rtc.EngineConfig;
import com.example.chiky.agora.rtc.EventHandler;
import com.example.chiky.agora.stats.StatsManager;
import com.example.chiky.providers.ExoPlayerProvider;
import com.example.chiky.providers.JacksonProvider;
import com.example.chiky.providers.RoomProvider;
import com.example.chiky.retrofit.Const;
import com.example.chiky.socket.CallHandler;
import com.example.chiky.socket.MySocketManager;
import com.example.chiky.utils.TempUtil;
import com.example.chiky.videocall.CallIncomeActivity;
        ...
        public void onCallRequest(Object[] args1) {
            if (args1 != null) {
                ...
                try {
                    ...
                    Log.d(TAG, "getGlobalSocket: err " + e);
                    e.printStackTrace();
                }
