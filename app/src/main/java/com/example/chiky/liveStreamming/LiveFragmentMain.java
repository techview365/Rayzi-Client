...
import com.example.chiky.databinding.FragmentLiveBinding;
...
import com.example.chiky.reels.VideoListFragment;
...
public class LiveFragmentMain extends BaseFragment {
    ...
    private final String[] categories = new String[]{"All", "Popular", "Following"};
